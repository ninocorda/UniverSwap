...
export interface TokenFactoryInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [
      BigNumberish,
      IERC20Template.TokenInitStruct,
      IERC20Template.TokenConfigStruct
    ]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTemplateImplementation",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "templateImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TokenFactory extends BaseContract {
  ...
  createToken: TypedContractMethod<
    [
      tierId: BigNumberish,
      init: IERC20Template.TokenInitStruct,
      cfg: IERC20Template.TokenConfigStruct
    ],
    [string],
    "payable"
  >;
  ...
  setTemplateImplementation: TypedContractMethod<
  ...
  templateImplementation: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "setTemplateImplementation"
  ): TypedContractMethod<[template_: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "templateImplementation"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
